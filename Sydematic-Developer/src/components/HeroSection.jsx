...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute top-40 right-32 w-16 h-16 rounded-full bg-accent/20 animate-float cursor-project"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute bottom-32 left-32 w-12 h-12 rounded-full bg-aurora-cyan/20 animate-float cursor-project"
        style={{ animationDelay: "4s" }}
      />
      <div
        className="absolute top-60 right-20 w-8 h-8 rounded-full bg-aurora-pink/20 animate-float cursor-project"
      ...
      <div
        className="absolute top-32 right-1/4 w-1 h-1 rounded-full bg-foreground animate-twinkle"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-20 left-1/3 w-1.5 h-1.5 rounded-full bg-foreground animate-twinkle"
        style={{ animationDelay: "2s" }}
      />
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
        <div className="animate-slide-up">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
            Where <span className="text-primary font-semibold">Movies</span>,{" "}
            <span className="text-accent font-semibold">Math</span>, and{" "}
